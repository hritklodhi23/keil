 ...
 *
 * @note
 * Modified by Quantum Leaps to allow debugging in the KEIL Simulator.
 * Specifically, the macro definition CLOCK_SETUP has been changed to 0.
 *
 * @note
 * modified by Keil
 ******************************************************************************/
...
//
#define CLOCK_SETUP 0 /* <== modified by Quantum Leaps */
